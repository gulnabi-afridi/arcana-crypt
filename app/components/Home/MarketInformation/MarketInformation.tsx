...
const MarketInformation = () => {
  return (
    <div className='w-full flex flex-col bg-[#09303c] border-[1px] borderColor rounded-[16px] '>
      ...
      {/* trade ---->   */}
      <div className='w-full bg-[#012A36] py-4 flex justify-between items-center border-b-[1px] borderColor px-8'>
      ...
      {/* stats ---> */}
      <div className='w-full bg-transparent flex flex-col gap-8 px-8 py-4 border-b-[1px] borderColor'>
        ...
        <div className='w-full flex justify-start items-center gap-4'>
          <div className='flex flex-col gap-2'>
            <p className='text-[14px] text-white/50 font-medium'>Base token</p>
            <div className='flex justify-center items-center bg-[#012A36] py-[6px] px-[8px] rounded-[8px] gap-2'>
              ...
              />
              <p className='text-[20px] text-white font-medium'>Pyth network</p>
              <button>
          ...
          <div className='flex flex-col gap-2'>
            <p className='text-[14px] text-white/50 font-medium'>Quote token</p>
            <div className='flex justify-center items-center bg-[#012A36] py-[6px] px-[8px] rounded-[8px] gap-2'>
              <Image
                ...
                className='object-fill'
              />
              <p className='text-[20px] text-white font-medium'>USD Coin</p>
              <button>
                <Icons.share ClassName='w-[20px] h-[20px]' />
              </button>
            </div>
